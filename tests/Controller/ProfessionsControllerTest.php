...
class ProfessionsControllerTest extends WebTestCase
{
    ...
    {
        $path = '/professions/'; // Assurez-vous que $this->path contient le bon chemin

        $crawler = $this->client->request('GET', $path);

        self::assertResponseStatusCodeSame(200);
        $this->assertResponseIsSuccessful();
        $this->assertSelectorTextContains('title', 'Professions index'); // Correction de la chaîne attendue
