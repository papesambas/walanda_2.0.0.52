...
class LieuNaissancesControllerTest extends WebTestCase
{
    ...
    private LieuNaissancesRepository $repository;
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = static::getContainer()->get('doctrine')->getRepository(LieuNaissances::class);
    ...
    {
        $path = '/lieu/naissances/'; // Assurez-vous que $this->path contient le bon chemin

        $crawler = $this->client->request('GET', $path);

        self::assertResponseStatusCodeSame(200);
        $this->assertResponseIsSuccessful();
        $this->assertSelectorTextContains('title', 'LieuNaissances index'); // Correction de la chaîne attendue
